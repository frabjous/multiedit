...
function buildMenuItems(schema) {
  ...
  if (mark = schema.marks.inlinemath) {
    r.toggleInlineMath = markItem(mark, { title: "Toggle inline math", render: gicon('function') });
  }
  if (mark = schema.marks.displaymath) {
    r.toggleDisplayMath = markItem(mark, { title: "Toggle display math", render: gicon('calculate') });
  }
  ...
  r.inlineMenu = [cut([r.toggleStrong, r.toggleEm, r.toggleUnderline, r.toggleSuperscript, r.toggleSubscript, r.toggleLink, r.toggleInlineMath, r.toggleDisplayMath])];
