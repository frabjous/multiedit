...
/////////////////////////////////////////////////////////////////////////
// This module loads the javascript needed to create the multieditors  //
...
// load individual types of editor and make available
import getEditor from './plaineditors.mjs';
import getProseEditor from './proseeditors.mjs';
if (!window.getEditor) window.getEditor = getEditor;
if (!window.getProseEditor) window.getEditor = getProseEditor;
...
// main function
export default function multieditor(opts) {
